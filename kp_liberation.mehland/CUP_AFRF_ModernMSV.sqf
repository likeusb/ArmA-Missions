...
opfor_transport_truck = "CUP_O_Kamaz_6396_covered_RUS_M";                               // Kamaz-6396 Transport (Covered)
opfor_ammobox_transport = "CUP_O_Kamaz_6396_transport_RUS_M";                        // Kamaz 6396 Transport -> Has to be able to transport resource crates!
opfor_fuel_truck = "CUP_O_Kamaz_6396_fuel_RUS_M";                             // Kamaz 6396 Fuel
opfor_ammo_truck = "CUP_O_Kamaz_6396_ammo_RUS_M";                             // Kamaz 6396 Ammo
